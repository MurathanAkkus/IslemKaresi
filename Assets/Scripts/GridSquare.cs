...
{                                    // basit secilebilir nesne ve kontroller kullanilabilinir.
    ...
    private void DisplayText(GameObject square)
    {
        ...
        else
        {
            ...
            if (!IsRes_Square() && !IsOpt_Square())
            {
                if (number_ == "1" && NumberButtons.instance.numberButtons[0].activeSelf)
                    NumberButtons.instance.numberButtons[0].SetActive(false);
                if (number_ == "2" && NumberButtons.instance.numberButtons[1].activeSelf)
                    NumberButtons.instance.numberButtons[1].SetActive(false);
                if (number_ == "3" && NumberButtons.instance.numberButtons[2].activeSelf)
                    NumberButtons.instance.numberButtons[2].SetActive(false);
                if (number_ == "4" && NumberButtons.instance.numberButtons[3].activeSelf)
                    NumberButtons.instance.numberButtons[3].SetActive(false);
                if (number_ == "5" && NumberButtons.instance.numberButtons[4].activeSelf)
                    NumberButtons.instance.numberButtons[4].SetActive(false);
                if (number_ == "6" && NumberButtons.instance.numberButtons[5].activeSelf)
                    NumberButtons.instance.numberButtons[5].SetActive(false);
                if (number_ == "7" && NumberButtons.instance.numberButtons[6].activeSelf)
                    NumberButtons.instance.numberButtons[6].SetActive(false);
                if (number_ == "8" && NumberButtons.instance.numberButtons[7].activeSelf)
                    NumberButtons.instance.numberButtons[7].SetActive(false);
                if (number_ == "9" && NumberButtons.instance.numberButtons[8].activeSelf)
    ...
    {
        if (selected_ && !has_default_value && !IsOpt_Square())
        {
            number_ = " ";
            has_wrong_value = false;
            SetSquareColor(Color.white);
    ...
    public void OnSetNumber(int number, GameObject number_button)
    {
        if (selected_ && !has_default_value)
        {
            SetSquareNumber(number.ToString());
            if (!IsOpt_Square() && !IsRes_Square() && IsCorrectNumberSet())
    ...
    public bool IsRes_Square()
    {
        int i = square_index_;
        if (i == 5 || i == 17 || i == 29 || i == 30 || i == 32 || i == 34)
            return true;
        return false;
    }
}