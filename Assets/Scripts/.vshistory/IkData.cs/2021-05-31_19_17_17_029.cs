...
{
    static string str, num_opt;
    public List<IkData.IkBoardData> getData()
    {
        List<string> solved = new List<string>();

        List<GameObject> grid_squares_ = new List<GameObject>(); // Grid'in karelerinin listesi
                ...
                if (column_number != 1 && column_number != 3)
                {
                    if (row_number != 1 && row_number != 3)
                    {
                        ...
                        if (div_ == 'x' || div_ == 'y' || div_ == 'z')
                        {
                            ...
                            square.GetComponent<GridSquare>().SetNumber(number.ToString());
                        ...
                        else
                        {
                            ...
                            square.GetComponent<GridSquare>().SetNumber(numbers[number].ToString());
        ...
        foreach(var square in grid_squares_)
        {
            if (square.active == false)
                ...
                solved[iter] = square.GetComponent<GridSquare>().number_text.GetComponent<Text>().text;
            Debug.Log(solved[iter] + "\t");
            iter++;
        }
