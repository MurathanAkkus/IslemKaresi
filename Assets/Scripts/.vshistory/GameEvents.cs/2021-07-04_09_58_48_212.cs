...
public class GameEvents : MonoBehaviour
{
    ...
    ////*******************************
    //public delegate void NumberButtonActive(int value);

    //public static event NumberButtonActive OnNumberButtonActive;

    //public static void OnNumberButtonActiveMethod(int value)
    //{
    //    if (OnNumberButtonActive != null)
    //        OnNumberButtonActive(value);
    //}
}
