...
public class GameEvents : MonoBehaviour
{
    ...
    public delegate void UpdateSquareNumber(int number, GameObject number_button);
    public static event UpdateSquareNumber OnUpdateSquareNumber;

    public static void UpdateSquareNumberMethod(int number, GameObject number_button)
    {
        if (OnUpdateSquareNumber != null)
            OnUpdateSquareNumber(number, GameObject number_button);
    }
    ...
    //*******************************
    public delegate void GiveAHintAdOpenning();

    public static event GiveAHintAdOpenning OnGiveAHintAdOpenning;

    public static void OnGiveAHintAdOpenningMethod()
    {
        if (OnGiveAHintAdOpenning != null)
            OnGiveAHintAdOpenning();
    }

    //*******************************
    public delegate void CheckNumberControl();

    public static event CheckNumberControl OnCheckNumberControl;

    public static void CheckNumberControlMethod()
    {
        if (OnCheckNumberControl != null)
            OnCheckNumberControl();
    }

    //*******************************
    public delegate void NumberButtonControl();

    public static event NumberButtonControl OnNumberButtonControl;

    public static void NumberButtonControlMethod()
    {
        if (OnNumberButtonControl != null)
            OnNumberButtonControl();
    }
}
