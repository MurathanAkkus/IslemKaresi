...
public class Config : MonoBehaviour
{
    ...
    public static void SaveBoardData(IkData.IkBoardData board_data, string level, int board_index,
        int error_number, Dictionary<string, List<string>> grid_notes, Color[] cols)
    {
        ...
        foreach (var col in cols)
        {
            ...
            {
                if (col.ToString() == "RGBA(1.000, 0.000, 0.000, 1.000)")
                    col_string += "Red" + ",";
                else if (col.ToString() == "RGBA(0.784, 0.890, 0.816, 0.784)")
                    col_string += "Grn" + ",";
                else
                    col_string += "White" + ",";
            }
