...
public class IkGrid : IkGridBase, MonoBehaviour // Unity Script'leri icin, MonoBehaviour miras alinir. Her Unity script'inin turetildigi temel siniftir....
{                                   //...Bu sayede; Start,FixUpdate,Update gibi metotlar kullanilabilinir.
    ...
    private void SetGridNumber()
    {
        ...
        private string[,] x_array = new string[6, 6];
    private string[,] y_array = new string[6, 6];
    ...
    public List<int> numbers = new List<int>(new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
            ...
            int Division(char div_)
            {
                ...
                //                if (divisible)
                //                {
                //                    square.GetComponent<GridSquare>().SetNumber(number); // Listeden rastgele bir rakam alindi
                //                    numbers.Remove(number);
                //                }
                //                else
                //                {   // Listeden rastgele bir rakam alindi
                //                    square.GetComponent<GridSquare>().SetNumber(numbers[number]);
