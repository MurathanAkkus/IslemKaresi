...
{                                   //...Bu sayede; Start,FixUpdate,Update gibi metotlar kullanilabilinir.
    ...
    {
        Debug.Log("asdfaskdfþaldsjfAÝÞJSDKFÝAJFÝLDJFÞAJSFÞ");
    ...
    private void OnDisable()
    {
        ...
        //***************************************
        var solved_data = IkData.Instance.ik_game[GameSettings.Instance.GetGameMode()][selected_grid_data].solved_data;
        ...
        if (!GameSettings.Instance.GetExitAfterWon()) // board tamamlandiktan sonra cikarken verileri kaydetme
            Config.SaveBoardData(current_game_data,
                ...
                grid_notes, IkData.Instance.ik_game[GameSettings.Instance.GetGameMode()].Count);
        else
