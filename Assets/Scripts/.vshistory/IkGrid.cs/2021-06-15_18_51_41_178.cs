...
{                                   //...Bu sayede; Start,FixUpdate,Update gibi metotlar kullanilabilinir.
    ...
    string str, num;
    List<string> solved = new List<string>(new string[36]);
    ...
    public List<string> SetGridValues()
    {
        ...
        foreach (var square in grid_squares_)
        {
            if (column_number == 5 && row_number != 5)
            {
                ...
                {
                    num = square.GetComponent<Results>().Result(Trans(x_array, row_number));
                    str = "";
                }
                else
            ...
            else if (row_number == 5)
            {
                ...
                {
                    num = square.GetComponent<Results>().Result(Trans(y_array, column_number));
                    str = "";
                }
            ...
            solved.Add(square.GetComponent<GridSquare>().number_text.GetComponent<Text>().text);
            column_number++;
