...
{                                   //...Bu sayede; Start,FixUpdate,Update gibi metotlar kullanilabilinir.
    ...
    private void SetAllSqaureColor()
    {
        ...
        Color opt_col = new Color32(200, 227, 208, 200);
        foreach(var square in grid_squares_)
        {
            i = grid_squares_.IndexOf(square);
            str = square.GetComponent<GridSquare>().GetSquareNumber();
            if (str.Equals("*") || str.Equals("/") || str.Equals("+") || str.Equals("-"))
                square.GetComponent<GridSquare>().SetSquareColor(opt_col);
            else if (i == 5 || i == 17 || i == 29 || i == 30 || i == 32 || i == 34)
                square.GetComponent<GridSquare>().SetSquareSizeUp(0.15f, square);
            grid_squares_color[i] = square.GetComponent<GridSquare>().GetSquareColor();
        }
    }
