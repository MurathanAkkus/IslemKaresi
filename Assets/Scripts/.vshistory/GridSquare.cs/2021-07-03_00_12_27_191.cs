...
{                                    // basit secilebilir nesne ve kontroller kullanilabilinir.
    ...
    private void DisplayText(GameObject square)
    {
        ...
        else if (number_ == "*" || number_ == "/" || number_ == "+" || number_ == "-")
        {
            number_text.GetComponent<Text>().fontSize += 100;
            this.SetSquareColor(Color.blue);
            number_text.GetComponent<Text>().color = Color.blue;
        }
    }
