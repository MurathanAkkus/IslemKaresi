...
public class GameEvents : MonoBehaviour
{
    ...
    //*******************************
    public delegate void ConWithAdOpenning();

    public static event ConWithAdOpenning OnConWithAdOpenning;

    public static void OnConWithAdOpenningMethod()
    {
        if (OnConWithAdOpenning != null)
            OnConWithAdOpenning();
    }
}
