...
{                                   //...Bu sayede; Start,FixUpdate,Update gibi metotlar kullanilabilinir.
    ...
    private void SetSquaresPosition()
    {
        ...
        start_position.x -= offset.x / 15;
        start_position.y -= offset.y / 15;
        foreach (GameObject square in grid_squares_)
        {
            ...
            if (column_number == 5 && (row_number == 0 || row_number == 2 || row_number == 4))
                pos_x_offset += offset.x / 15; // Bu iki if; sonuc degerlerinin oldugu Grid'ler oldugu icin...
            if (row_number == 5 && (column_number == 0 || column_number == 2 || column_number == 4))
                pos_y_offset += offset.y / 15; // ...ekstra offset ekliyorum, ama cok uzaklasmamasi icin /7 var
    ...
    private void GiveAHint()
    {
        ...
        for (int index = 0; index < grid_squares_.Count; index++)
        {
            ...
            if (comp.GetSquareNumber() == " " && !comp.GetHasDefaultValue() && !comp.IsRes_Square() && !comp.IsOpt_Square())
        ...
        int cor_num = int.Parse(comp.number_text.GetComponent<Text>().text);
        if (cor_num == 1 && NumberButtons.instance.numberButtons[0].activeSelf)
            NumberButtons.instance.numberButtons[0].SetActive(false);
        if (cor_num == 2 && NumberButtons.instance.numberButtons[1].activeSelf)
            NumberButtons.instance.numberButtons[1].SetActive(false);
        if (cor_num == 3 && NumberButtons.instance.numberButtons[2].activeSelf)
            NumberButtons.instance.numberButtons[2].SetActive(false);
        if (cor_num == 4 && NumberButtons.instance.numberButtons[3].activeSelf)
            NumberButtons.instance.numberButtons[3].SetActive(false);
        if (cor_num == 5 && NumberButtons.instance.numberButtons[4].activeSelf)
            NumberButtons.instance.numberButtons[4].SetActive(false);
        if (cor_num == 6 && NumberButtons.instance.numberButtons[5].activeSelf)
            NumberButtons.instance.numberButtons[5].SetActive(false);
        if (cor_num == 7 && NumberButtons.instance.numberButtons[6].activeSelf)
            NumberButtons.instance.numberButtons[6].SetActive(false);
        if (cor_num == 8 && NumberButtons.instance.numberButtons[7].activeSelf)
            NumberButtons.instance.numberButtons[7].SetActive(false);
        if (cor_num == 9 && NumberButtons.instance.numberButtons[8].activeSelf)
            NumberButtons.instance.numberButtons[8].SetActive(false);
    }
